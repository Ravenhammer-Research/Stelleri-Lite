...
public:
  ...
  OvpnInterfaceConfig(const InterfaceConfig &base, std::unique_ptr<IPAddress> source,
  ...
  OvpnInterfaceConfig(const OvpnInterfaceConfig &o) : InterfaceConfig(o), options(o.options),
